...
# QQ邮箱
# def setemail(content, title, from_name, from_address, to_address, serverport, serverip, username, password,
#              filename):
...
#     to = ['xianlimei@cai-inc.com', '344792860@qq.com', 'wb-chenjingjing@cai-inc.com']
#     config = {
#         "from": "344792860@qq.com",
#         "from_name": 'UI自动化测试:',
#         "to": to,
#         "serverip": "smtp.qq.com",
#         "serverport": "465",
#         "username": "344792860@qq.com",
#         "password": "ckcrdpjwdkhbbjee",  # QQ邮箱的SMTP授权码
#         "title": "疫苗Vaccine自动化测试报告"
#     }


def sendemail(filename):
    to = ['xianlimei@cai-inc.com', 'XXX@qq.com']  # 收件人，多个收件人以逗号分隔
    config = {
